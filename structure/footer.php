		...
		<div class="row">
			...
			<div class="col-md-8 right-foot">
				<div class="col-md-12 flcontainer-foot">
					<div class="row">
						<div class="col-md-2 text-center">
							<p class="nu-fort"><?php echo FORT_FOOTER; ?></p>
						</div>
				...
				<div class="advert-foot text-center">
					<a href="privacy.php<?php echo $nextLan; ?>"><p><?php echo PRIVACY_00_FOOTER; ?></p></a>
					<p>
						<?php echo PRIVACY_01_FOOTER; ?>
					</p>

					<p class="tels-foot color-white">
						<?php echo PHONE_FOOTER; ?>
					</p>
				</div>
			</div>
		</div>
